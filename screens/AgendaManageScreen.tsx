...
import { Notification, Event, CountdownItem } from '../types';
...
interface AgendaManageScreenProps {
  ...
  onSaveCountdowns: (items: CountdownItem[]) => void;
}

export const AgendaManageScreen: React.FC<AgendaManageScreenProps> = ({ 
  onBack, 
  onAddNotification, 
  events, 
  onSaveEvent,
      ...
      <main className="flex-1 px-4 space-y-8 overflow-y-auto pb-32">
        ...
        <section id="event-form">
          ...
          <div className="space-y-4">
            ...
            <button 
              onClick={handleSave}
              className={`w-full text-white font-bold py-4 rounded-xl shadow-lg flex items-center justify-center gap-2 mt-2 transition-all active:scale-[0.98] ${
                editingId 
