...
interface TeamDrankBillingExcelPreviewScreenProps {
  onBack: () => void;
}
...
export const TeamDrankBillingExcelPreviewScreen: React.FC<TeamDrankBillingExcelPreviewScreenProps> = ({ onBack }) => {
  ...
  useEffect(() => {
    const savedLink = localStorage.getItem('teamDrankBillingExcelLink');
    if (savedLink) {
      ...
      <main className="flex-1 relative overflow-hidden bg-gray-100 dark:bg-[#0f172a]">
        ...
        <div className="absolute inset-0 flex items-center justify-center p-6 bg-black/5 backdrop-blur-[1px]">
           <div className="bg-white dark:bg-[#1e293b] rounded-2xl shadow-2xl p-6 max-w-sm w-full border border-gray-200 dark:border-gray-700 text-center">
              ...
              <h2 className="text-xl font-bold text-gray-900 dark:text-white mb-2">Excel Drankrekeningen</h2>
              <p className="text-sm text-gray-500 dark:text-gray-400 mb-6 leading-relaxed">
                 Je wordt nu doorgestuurd naar het externe Excel bestand voor de drankrekeningen.
              </p>
