    ...
    <div className="flex flex-col h-screen bg-gray-50 dark:bg-[#0f172a] text-gray-900 dark:text-white transition-colors duration-200">
      ...
      <main className="flex-1 overflow-y-auto p-4 space-y-6">
        ...
        <div 
          ...
          className={`p-4 rounded-xl border flex items-start gap-4 cursor-pointer transition-all shadow-sm ${
            isOfficial ? 'bg-blue-50 dark:bg-blue-900/20 border-blue-200 dark:border-blue-800' : 'bg-white dark:bg-[#1e293b] border-gray-200 dark:border-gray-800'
          }`}
        >
           ...
           <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center mt-1 transition-all ${
              isOfficial ? 'bg-blue-600 border-blue-600' : 'border-gray-300 dark:border-gray-500'
           }`}>
